const GOOGLE_API_KEY = 'AIzaSyDBRPUjO-93-MY7G_s3qYanksSl2dQoe2ct';
...
export async function getAddressFromCoords(coords) {
  ...
  return address;
  // results key is an array and the first element in the array has this formatted_address field.
}
