...
// const ProjectItem = 'abc';  // Unused code.

// console.log(DEFAULT_VALUE);

export class ProjectList {
  // projects = [];  // This is very new syntax, webpack and EsLint don't support it.

  constructor(type) {
    this.type = type;
    this.projects = [];  // Instead add this.projects as a property here in the constructor.
